...
/// <summary>
/// This class is responsible for shaking rotation through commands
/// </summary>
public class ShakeRotation : ICommand
{
    ...
    /// </para>
    /// </summary>
    public ShakeRotation(GameObject objectToAnimate, Vector3 shakeRotation, float time, MonoBehaviour monoBehaviour = null, Action onStart = null, Action onComplete = null,
    ...
    public async Task ExecuteAsync()
    {
        ...
        {
            iTween.ShakeRotation(objectToAnimate, iTween.Hash("name", objectToAnimate.name, "amount", shakeRotation, "easetype", typeAnimation, "time", time, "ignoretimescale", true,
